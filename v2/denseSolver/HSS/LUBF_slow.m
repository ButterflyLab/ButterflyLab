function  [L,U] = LUBF_slow(Afac,x,k,rk,tol,mr,lsz,method)
...
if M>lsz
    ...
    L.A21 = MVBFslow(A21U11, A21U11t, (1:N1)', [1,N1+1], (1:N2)', [1,N2+1], rk, tol, 0);
    ...
    U.A12 = MVBFslow(L11A12, L11A12t, (1:N1)', [1,N1+1], (1:N2)', [1,N2+1], rk, tol, 0);
