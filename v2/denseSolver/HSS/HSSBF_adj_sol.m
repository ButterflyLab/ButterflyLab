function y = HSSBF_adj_sol(Factor, p)
% HSSBF_adj_sol applies the adjoint of the data-sparse inverse of a 
...
if Factor.isLeaf
    ...
    p = Factor.Bctr(p);
    A11invp = HSSBF_adj_sol(Factor.A11inv,p(1:n1,:));
    A22invp = HSSBF_adj_sol(Factor.A22inv,p((n1+1):end,:));
    y = [A11invp;A22invp];
end
end
