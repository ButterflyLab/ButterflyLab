function Factor = MVBFslow2D(fun, fun_adj, xx, xbox, kk, kbox, mR, tol, disp_flag)
    ...
    for x2=1:npx2
        ...
        for k1=1:npk1
            for k2=1:npk2
                ...
                RrVC = f2'*VC;
                VRRc = VR'*f1;
                [Utmp,Stmp,Vtmp] = BF_svdtrunc_rank(pinv(RrVC) * f2'*BR * pinv(VRRc),mR,tol);
        ...
        [WPreSpr,CPreSpr] = BF_compression2D(WPreSpr,CPreSpr,U,xxsub,xidx{x1,x2},xsubbox,mR,tol,1,levels,XYmesh);
    end
end
...
for k1=1:npk1
    for k2=1:npk2
        ...
        [WPreSpr,CPreSpr] = BF_compression2D(WPreSpr,CPreSpr,V,kksub,kidx{k1,k2},ksubbox,mR,tol,1,levels,XYmesh);
    end
end
